...
The app also serves a frontend directly from FastAPI. Open your browser and go to:

```
http://localhost:8000/
```

This is the **Medicare RAG Assistant** page (`static/index.html`) — a simple chat-style UI where you can type a question and get an answer sourced from the indexed Medicare document, without needing Swagger UI or curl.
